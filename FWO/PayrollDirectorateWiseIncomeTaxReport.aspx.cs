...
namespace FRDP
{
    public partial class PayrollDirectorateWiseIncomeTaxReport : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            try
            {
                ...
                string reportPath = Server.MapPath("PayrollDirectorateWiseIncomeTaxReportRpt.rdlc");
