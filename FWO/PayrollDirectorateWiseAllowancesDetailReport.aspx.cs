...
namespace FRDP
{
    public partial class PayrollDirectorateWiseAllowancesDetailReport : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            try
            {
                ...
                string reportPath = Server.MapPath("PayrollDirectorateWiseAllowanceReportRpt.rdlc");
