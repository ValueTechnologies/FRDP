...
namespace FRDP
{
    public partial class PayrollDirectorateWiseNetSalaryReport : System.Web.UI.Page
    {
        ...
        //        ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("DataSet1", ds.Tables["usp_DirectorateWiseNetSalaryReport"]));
        ...
        private void ShowReport()
        {
            try
            {
                ...
                DSPayroll ds = new DSPayroll();
                string reportPath = Server.MapPath("PayrollDirectorateWiseNetSalaryRpt.rdlc");
