<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="accPostV.aspx.cs" Inherits="FRDP.accPostV" %>
            ...
            <table style="width: 99%;">
                ...
                <tr>
                    <td style="padding-left: 47px">
                        <asp:Button ID="Button1" runat="server" CssClass="btn btn-info" Text="Search vouchers" ClientIDMode="Static" />
                    </td>
                    <td style="padding-left: 25px;">&nbsp;</td>
                </tr>
            </table>
        </div>
        <div class="tab0" id="eno">
            &nbsp;<div class="tab1" style="float: left">&nbsp;Search Result List</div>
            <div class="tab2">&nbsp;</div>
        </div>
        <%-- <div id="VSearchList" class="ButtonClass" style="width: 92%; margin-bottom: 5px">Search Result List</div>--%>
            ...
            <asp:GridView ID="gvVList" runat="server" AutoGenerateColumns="False" DataKeyNames="VoucherID" DataSourceID="dsVlist" BorderStyle="None" GridLines="Horizontal" Width="100%" ShowHeader="False">
                <Columns>
                    ...
                    <asp:BoundField DataField="Memo" HeaderText="Description" SortExpression="Memo">
                        <ItemStyle VerticalAlign="Middle" Width="60%" />
                    </asp:BoundField>
...
WHERE        (TblVoucherHDR.CompanyID = @br) AND (TblVoucherHDR.EntryDate BETWEEN @d1 AND @d2) AND (TblVoucherHDR.Posted = 0) AND (format(TblVoucherHDR.EntryDate, 'MMMM yyyy') = @AMonth)">
                ...
                <tr>
                    <td colspan="2">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td colspan="2">
                                    <input id="txJMemo" style="border-style: none; width: 745px" type="text" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
  ...
  Verified By:_______________________<br /><br /><br />Approved By:_______________________</div>
        ...
        <table style="width: 99%;">
            ...
            <tr>
                <td>
                    <asp:Button ID="btnNewVoucher" runat="server" ClientIDMode="Static" CssClass="btn btn-info hidden" Text="Add New Voucher" /><input type="button" id="btnSaveV" value="Post Voucher" class="btn btn-info" />&nbsp;<input type="button" id="btnprtP" value="Print Voucher" class="btn btn-info" style="display: none" />
                </td>
            </tr>
        </table>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".vlist").live('click', function (e) {
                ...
                dels = "";
                $.ajax({
                    url: "accVSearchList.ashx/?ID=" + VouID,
            ...
            $('.AcName').live('focusout', function (e) {
                ...
                if ($(this).attr("tag") == "") { alert("Invalid Account !"); }
            }); //end keypress
            ...
            $('#btnSaveV').live('click', function () { //get data from table
                if (vdcheck()) {
                    ...
                    $.ajax({
                        url: "accupdateJV.ashx/?ID=" + dataIN + "¦" + $('#txDate').val() + "¦" + dataUP + "¦" + $.cookie('UserID') + "¦" + dels + "¦" + $('#txJMemo').val() + "¦" + VouID + "¦1",
                        context: document.body,
                        success: function (responseText) {
                            if (responseText != "0") {
                                ...
                                $('span[title=' + VouID + ']').parent().parent().remove();
                                $('#Parea,#UpFiles,#btnSaveV,#btnprtP').hide('slow');
                                $('#eno').next().show('slow');
                            }
                        }
                    });
