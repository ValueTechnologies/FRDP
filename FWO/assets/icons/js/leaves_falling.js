...
Leaf1 =new Image();
Leaf1 = allTypeOfLeaves[0] = "assets/icons/images/leaf.png";//path to the image you will use
Leaf2 =new Image();
Leaf2 = allTypeOfLeaves[1] = "assets/icons/images/leaf1.png";//you can have up to 3 different kind of leaves
Leaf3 =new Image();
Leaf3 = allTypeOfLeaves[2] = "assets/icons/images/leaf2.png";//possible to add more

var speedC = 1;//here you can define speed of leaves
var rotation = 2;//define rotation of leaves
var rotationTrue = 1//whether leaves rotate (1) or not (0)
var numberOfLeaves = 30;//define number of leaves
var size = 70;//general size of leaves, final size is calculated randomly (with this number as general parameter)
