<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="GeneratorDataInput.aspx.cs" Inherits="FRDP.GeneratorDataInput" %>
                    ...
                    <table style="width: 96.4%; margin-left: 20px; margin-right: 20px;">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Oil Quantity</td>
                                <td>
                                    <input id="txtOilQuantity" class="gen Integer" type="text" style="width: 90%;" /></td>
                            </tr>

                            <tr>
                                <td>Coolent Quantity</td>
                                <td>
                                    <input id="txtcoolentQuantity" class="gen Integer" type="text" style="width: 90%;" /></td>
                                <td>Service Duration (Hours)</td>
                                <td>
                                    <input id="txtServiceDurationHours" class="gen Integer" type="text" style="width: 90%;" /></td>
                            </tr>

                            <tr>
                                <td>Min Fuel Level (Liter)</td>
                                <td>
                                    <input id="txtMinFuelLevelLiter" class="gen Integer" type="text" style="width: 90%;" /></td>
                                <td>Current Generator HRS</td>
                                <td>
                                    <input id="txtCurrentMeterReading" class="gen Integer" type="text" style="width: 90%;" /></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="txtGeneratorLifeHours" class="gen Integer" type="text" style="width: 90%;" /></td>
                                <td>Battery Modal</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input id="txtGeneratorBatteryAcidQty" class="gen Integer" type="text" style="width: 90%;" /></td>
                ...
                <div class="content">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <th style="width: 100px;">
                                    <input class="onoff" type="text" style="width: 90%;" /></th>
                                <th>
                                    <input class="onoff" type="text" style="width: 90%;" /></th>
                                <th>
                                    <input class="onoff" type="text" style="width: 90%;" /></th>
                                ...
                                <th>
                                    <input class="onoff" type="text" style="width: 90%;" /></th>
                                <th style="width: 26px;">
                                    <button class="btn btn-info" id="btnonoff" type="button" style="margin-top: 6px;">+</button></th>
                            </tr>
                        </tfoot>
                    </table>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>
                                    <input class="dre" type="text" style="width: 90%;" /></th>
                                <th style="width: 26px;">
                                    <button class="btn btn-info" id="btnDailyEntry" type="button" style="margin-top: 6px;">+</button></th>
                            </tr>
                        </tfoot>
                    </table>
                    ...
                    <table id="tblclsME" class="responsive table table-bordered">
                        ...
                        <tfoot>
                            <tr>
                                <td>
                                    <input class="clsME" type="text" style="width: 90%;" /></td>
                                <td>
                                    <input class="clsME Integer" type="text" style="width: 95%;" /></td>
                                <td>
                                    <input class="clsME Integer" type="text" style="width: 95%;" /></td>
                                <td>
                                    <input class="clsME" type="text" style="width: 95%;" /></td>
                                <td>
                                    <input class="clsME" type="text" style="width: 95%;" /></td>
                                <td>
                                    <button class="btn btn-info" id="btnME" type="button" style="margin-top: 6px;">+</button></td>
                            </tr>
                        </tfoot>
                    </table>
                    <%--   <div class="payment">
        ...
        <table style="width: 96.4%; margin-left: 20px; margin-right: 20px;">
            <tbody style="width: 400px">
                <tr>
                    ...
                    <td style="text-align: left;">
                        <input id="txtDipValue" class="clsonoff Integer" type="text" style="width: 125px;" /></td>
                </tr>
                <tr>
                    <td>Start Time</td>
                    <td>
