<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="addEmployeeToPension.aspx.cs" Inherits="FRDP.addEmployeeToPension" %>
            ...
            <div class="box gradient">
                ...
                <div class="title">
                    ...
                    <h4>
                        ...
                        <span>Search Employee to Add Employee to Pension</span>
                    </h4>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <form class="form-horizontal" action="#">
                            ...
                            <div class="form-row row-fluid">
                             ...
                             <div class="form-row row-fluid">
                                <div class="span12">
                                    <label class="form-label span3" for="normal">Bank</label>
                                    <div class="controls sel span6">
                                        <select class="nostyle" id="ddlBank"></select>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnSave').bind('click', function () {
                ...
                ctrlVals += $('#btnSave').attr('tag') + '½' + $('#ddlBank').val();
