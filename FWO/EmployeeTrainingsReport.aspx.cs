...
namespace FRDP
{
    public partial class EmployeeTrainingsReport : System.Web.UI.Page
    {
        ...
        protected void AjaxUploadAttech_UploadComplete(object sender, AjaxControlToolkit.AjaxFileUploadEventArgs e)
        {
            ...
            if (data[1] == "2")
            {
                string fileID = Fn.ExenID("INSERT INTO tblEmpDocs (UploadedFor, EmpID,FileTitle, FileExt) VALUES ('EmpTrainings'," + data[0] + ", '" + fi.Name + "', '" + ext + "');select SCOPE_IDENTITY()");
