<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="GeneratorDataInputRefueling.aspx.cs" Inherits="FRDP.GeneratorDataInputRefueling" %>
                                    ...
                                    <table style="width: 96.4%; margin-left: 20px; margin-right: 20px;">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 40%;">
                                                    <input class="dre" type="text" style="width: 90%;" /></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; width: 40%;">
                                                    <input class="dre" type="text" style="width: 90%;" /></td>
                                                <td style="width: 100px;">In Tank Fuel(Litters)</td>
                                                <td style="text-align: left;">
                                                    <input class="dre" type="text" style="width: 90%;" /></td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td style="width: 100px;">Input Fuel(Litters)</td>
                                                <td style="text-align: left; width: 40%;">
                                                    <input class="dre" type="text" style="width: 90%;" /></td>
                                                <td style="width: 100px;">Gage Before</td>
                                                <td style="text-align: left;">
                                                    <input class="dre" type="text" style="width: 90%;" /></td>
                                            </tr>

                                            <tr>
                                                <td style="width: 100px;">Gage Aafter</td>
                                                <td style="text-align: left; width: 40%;">
                                                    <input class="dre" type="text" style="width: 90%;" /></td>
                                                <td style="width: 100px;">Fuel Slip No</td>
                                                <td style="text-align: left;">
                                                    <input class="dre" type="text" style="width: 90%;" /></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>
                                                    <button class="btn btn-info" id="btnDailyEntry" type="button" style="margin-top: 6px;">Save</button>
                                                    <button class="btn" id="btnDailyEntryCancel" type="button" style="margin-top: 6px;">Cancel</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
...
<td>' + itm.OilLtrs + '</td>\
            ...
            $('#btnDailyEntryCancel').live('click', function () {
                $('.dre').each(function (index, element) {
                    // element == this
                    $(this).val('');
                });
            ...
            function tblRefuelingLoad() {
                if ($($('.dre')[0]).val() != "") {
                    $.ajax({
                        type: "POST",
                        url: "gen.ashx/?ID=18ǁ" + $('#geninfo').attr('tg') + "ǁ" + $($('.dre')[0]).val(),
                        success: function (response) {
                            var jd = $.parseJSON(response), opt = '';
                            //alert(response);
                            $.each(jd, function (i, itm) {
                                ...
                                opt += '<tr>\
                                        ...
                                        <td>' + itm.FuelPrice + '</td>\
                                        <td><button tg= "'+ itm.tblGeneratorReFuelingID + '" class="btnDelonoff btn btn-danger" type="button" style="margin-top: 6px;">-</button></td>\
                                      </tr>';
                            });
...
<td>' + itm.MeterKWHEnd + '</td>\
            ...
            $('.btnDelonoff').live('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "gen.ashx/?ID=17ǁ" + $tx.attr('tg'),
                    success: function (response) {
                        if (response == "1") {
