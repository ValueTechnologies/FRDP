                ...
                $.ajax({
                    ...
                    success: function (responseText) {
                        ...
                        $.each(jdata, function (i, item) {
                            ...
                            $('.AcQ' + typ).append('<div class="table-row Grd"><div class="col">' + item.Degree + '</div><div class="col">' + item.Subject1 + '</div><div class="col">' + item.Completion + '</div><div class="col">' + item.Board + '</div><div class="col">' + item.CGPA + '</div><div class="col"><input type="button" Value="Edit" tag = ></div></div>');
                        });
                    }
                });
            }
