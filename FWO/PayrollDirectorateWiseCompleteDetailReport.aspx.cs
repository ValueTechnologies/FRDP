...
namespace FRDP
{
    public partial class PayrollDirectorateWiseCompleteDetailReport : System.Web.UI.Page
    {
        ...
        private void ShowReport()
        {
            try
            {
                ...
                string reportPath = Server.MapPath("PayrollDirectorateWiseDetailSalaryReportRpt.rdlc");
