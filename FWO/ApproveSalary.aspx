<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="ApproveSalary.aspx.cs" Inherits="FRDP.ApproveSalary" %>
        ...
        <div class="span12">
            ...
            <div class="box gradient">
                ...
                <div class="content noPad">
                    ...
                    <table id="tblEmpList" class="responsive table table-striped table-bordered table-condensed" style="width: 96%; margin-left: 20px; margin-right: 20px; border-right: 1px solid #c4c4c4;">
                        <thead>
                            <tr>
                                ...
                                <th>Department</th>
                                <th>Designation</th>
                                <th style="width: 52px;text-align:center;"><input id="chk" checked="checked" type="checkbox" /></th>
                            </tr>
                        </thead>
                        <tfoot>
                    ...
                    <br />
                    <br />
                    <div style="text-align:right; padding-right:27px;"><button id="btnUpdate" class="btn btn-info">Save</button></div>
                    <br />
                </div>
...
<div class="tab0" style="margin-left: 5px; margin-bottom: 20px;">
                  ...
                  <div class="span6">
                            ...
                            <div class="form-row row-fluid">
                                <div class="span6">
                                    <label class="form-label span6" for="normal">Personnel Installment</label>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnUpdate').live('click', function (e) {
                ...
                if (val=="") {
                    alertR('Please Check at least one option..!');
                }
            ...
            function LoadEmpList() {
                ...
                $.ajax({
                    type: "POST",
                    url: "EmpReg.ashx/?ID=102ǁ" + where + "ǁ" + $('#ddlSalaryMonth').val() + "ǁ" + $('#ddlSalaryYear').val(),
                    success: function (response) {
                        ...
                        $.each(jd, function (i, itm) {
                            opt += '<tr tg="' + itm.tblEmployeeID + '"><td>' + itm.EmpNo + '</td>\
                                    ...
                                    <td><input class="chk" tg="' + itm.tblEmployeeID + '" tag="' + itm.MonthlySalaryID + '" checked="checked" type="checkbox" /></td>\
                                    </tr>';
                        });
            ...
            $('.btnEdit').live('click', function (e) {
                ...
                //$('#btnSearchPreviousSalary').attr('tag', tg);
            ...
            $('.heading h3').html('Approve Gross Salary');
