...
{
    /// <summary>
    /// Summary description for accAccountsList
    /// </summary>
    public class accAccountsList : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            }
            {
                try
                {
                    ...
                    string lists = Fn.GetRecords("select dbo.fn_AccountsList_SingleCOA(" + dataID[0] + "," + dataID[1] + ")+'|'+dbo.fn_AcIDList_SingleCOA(" + dataID[0] + ")")[0];
