<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="VSARFQ.aspx.cs" Inherits="FRDP.VSARFQ" %>
                    ...
                    <div id="PrintArea" style="width: 99%">
                        ...
                        <div style="margin-bottom: 20px;">
                            <table style="width: 100%">
                                <tr>
                                    <td style="width: 110px;padding-left: 23px;">Select Vendor
                                    </td>
                                    <td>
