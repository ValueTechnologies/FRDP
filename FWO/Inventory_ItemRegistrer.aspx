<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="Inventory_ItemRegistrer.aspx.cs" Inherits="WFO.Inventory_ItemRegistrer" %>
            ...
            <div class="box gradient">
                ...
                <div class="content noPad">
                    ...
                    <div style="margin: 10px;">
                        ...
                        <button id="btnSetTotalLevel" disabled="disabled" class="btn btn-info marginB10">Save</button>
                    </div>
                </div>
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="box gradient">
                ...
                <div class="content noPad">
                    <br />
      <button id="btnAddRoot" disabled="disabled" class="btn btn-info" style="float:right; margin-right:10px;">Add Root</button><br /><br /><br />
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnUpdateNode').live('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "inv.ashx/?ID=4ǁ" + encodeURIComponent( $('#txtItemName').val()) + "ǁ" + $('#btnUpdateNode').attr('lid') + "ǁ" + chk + "ǁ" + encodeURIComponent($('#ddlUnitEdit').val()) + "ǁ" + $('#txtAlertEdit').val() + "ǁ" + encodeURIComponent($('#txtMenufecturerEdit').val()) + "ǁ" + encodeURIComponent($('#txtDescriptionEdit').val()),
                    success: function (response) {
                        if (response == 1) {
                            var str = $li.html();
            ...
            $('#btnAddNode').live('click', function () {
                ...
                if (lid == 'NULL') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "inv.ashx/?ID=5ǁ" + encodeURIComponent($('#txtIAddtemName').val()) + "ǁ" + $('#btnAddNode').attr('lid') + "ǁ" + chk + "ǁ" + encodeURIComponent($('#ddlUnit').val()) + "ǁ" + minstok + "ǁ" + manufect + "ǁ" + encodeURIComponent($('#txtDescription').val()),
                        success: function (response) {
                            alertG('Record Saved');
                            $('#txtIAddtemName').val('');
