...
//                    F = "<div class='fc-agenda-head' style='position:relative;z-index:4'><table style='width:100%'><tr class='fc-first" + (b.allDaySlot ? "" : " fc-last") +
...
//                x();
//                if (h)
//                    if (la(h)) L(h.row, h.col, h.row, h.col);
//                    else {
//                        h = P(h);
...
//            if (c)
//                if (o(f.target).parents(c).length) return;
//            b(f)
//        })
//    }
...
//    function fb(a, b) {
//        if (+a)
//            for (; a.getDate() != b.getDate() ;) a.setTime(+a +
//                (a < b ? 1 : -1) * Jb)
//    }
...
//    function bb(a, b) {
//        return 0;// (parseFloat(jQuery.curCSS(a, "paddingTop", true)) || 0) + (parseFloat(jQuery.curCSS(a, "paddingBottom", true)) || 0) + (parseFloat(jQuery.curCSS(a, "borderTopWidth", true)) || 0) + (parseFloat(jQuery.curCSS(a, "borderBottomWidth", true)) || 0) + (b ? tb(a) : 0)
//    }
...
//                            E = e.end ? e.end - (e._end || x.defaultEventEnd(e)) :
//                            0;
//                        for (j = 0; j < r; j++) {
//                            s = P[j];
//                            if (s._id == e._id && s != e) {
