<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="SearchVouchers.aspx.cs" Inherits="FRDP.SearchVouchers" %>
    ...
    <%--             <div class="form-row row-fluid">
                ...
                <div class="form-row row-fluid">
                    <div class="span6" style="margin-left: 0px;">
                        ...
                        <button type="button" id="btnSearch" class="btn btn-info span2" style="margin-left: 0px;">Search</button>
                    </div>
                </div>--%>
