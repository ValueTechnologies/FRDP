<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="CreateRFQ.aspx.cs" Inherits="FRDP.CreateRFQ" %>
                ...
                <div class="compose well">
                    ...
                    <form class="compose form-horizontal">
                                ...
                                <div class="row-fluid">
                                    <div class="span5">
                                        <select id="ddlReqType" style="width: 167px;">
                                            <option>Without Requisition</option>
                                            <option>With Requisition</option>
                                        </select>
                                        </div>
                        ...
                        <div class="form-row row-fluid">
                            ...
                            <div class="span1">
                                <div class="row-fluid">
                                    <label class="form-label span2" for="to">RFQ#:</label>
                                    <%--<input class="span10" id="txtReqNo" name="txtReqNo" type="text" value="" readonly="readonly" />--%>
                                </div>
                            </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <div class="row-fluid">
                                    ...
                                    <div class="span11">
                                        <div class="dvAdd" tg="1" style="display: none; float: right;">
                                            <select class="vlist" tg="1" style="width: 400px; margin-bottom: 10px;">
                                            </select>
                        ...
                        <div class="form-row row-fluid" style="margin-top: 0px !important;">
                            <div class="span12">
                                <div class="row-fluid">
                                    <h4>Brief  Description of (RFQ) <a href="#" class="icon tip"><span class="icon16 icomoon-icon-cog-2"></span></a></h4>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#ddlReqType').live('change', function (e) {
                ...
                e.preventDefault();
                if ($(this).val() == "Without Requisition") {
                    $('#ddlReq').html('');
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(jd, function (i, itm) {
                            opt += '<option  value="' + itm.tblInvReqMainID + '">' + itm.tblInvReqNo + '</option>';
                        });
                        $('#ddlReq').html(opt);
