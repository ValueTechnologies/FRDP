<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="PayrollDirectorateWiseCompleteDetailReport.aspx.cs" Inherits="FRDP.PayrollDirectorateWiseCompleteDetailReport" %>
    ...
    <div class="row-fluid">
      ...
      <script type="text/javascript">
          ...
          $(document).ready(function () {
              $('.heading h3').html('Office Wise Net Salary Report');
