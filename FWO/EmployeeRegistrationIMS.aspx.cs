...
namespace FRDP
{
    public partial class EmployeeRegistrationIMS : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static string GetCitiesList(string District)
        {
            return Fn.Data2Json("sp_SelectCities '" + District + "'");
        }
