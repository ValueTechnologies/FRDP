<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="accjV.aspx.cs" Inherits="FRDP.accjV" %>
            ...
            function GetVoucherNo() {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#JVNO').attr('title', 'JV/' + jData[0].VNo);
                        $('#JVNO').html('Voucher No. JV/' + jData[0].VNo);
                    }
                });
            }
            GetVoucherNo();
