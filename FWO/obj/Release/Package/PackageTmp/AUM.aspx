<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="AUM.aspx.cs" Inherits="FRDP.AUM" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tbl_form">
  <tr>
    ...
    <td width="60%"> <asp:TextBox ID="TextBox_Name" runat="server" CssClass="input_txt"></asp:TextBox></td>
  </tr>
  <tr>
    <td align="right">Priority :&nbsp;</td>
    <td><asp:TextBox ID="TextBox_Priority" runat="server" CssClass="input_txt" MaxLength="5"></asp:TextBox>
  ...
  <tr>
    <td align="right">&nbsp;</td>
    <td> <asp:Button ID="Button1" runat="server" CssClass="btn_l" Text="Save" OnClick="Button1_Click"> </asp:Button></td>
  </tr>
</table>
...
<br />
          ...
          <asp:SqlDataSource ID="SqlDataSource_Insert" runat="server" ConnectionString="<%$ ConnectionStrings:VD_DB_ConnectionString %>" DeleteCommand="UPDATE Admin_User_Module SET Status = 0 WHERE (Module_Id = @Module_Id)" InsertCommand="INSERT INTO Admin_User_Module(Module_Name, Priority, Moudle_Type, Status) VALUES (@Module_Name, @Priority, @Moudle_Type, @Status)" ProviderName="<%$ ConnectionStrings:VD_DB_ConnectionString.ProviderName %>" SelectCommand="SELECT Module_Name, Module_Id, Priority, Moudle_Type, Status FROM Admin_User_Module ORDER BY Priority, Status DESC" UpdateCommand="UPDATE Admin_User_Module SET Module_Name = @Module_Name, Priority = @Priority, Moudle_Type = @Moudle_Type, Status =@Status WHERE (Module_Id = @Module_ID)">
            <DeleteParameters>
        ...
        DataSourceID="SqlDataSource_Insert" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
              ...
              <asp:TemplateField>
                ...
                <ItemTemplate>
                  <asp:ImageButton ID="ImageButton_Edit" runat="server" CommandName="Select" ImageUrl="images/icon_edit.gif" OnClick="ImageButton_Edit_Click" />
         ...
         <div Class="lightbox">
            ...
            <table width="100%" border="0" cellspacing="3" cellpadding="3" id="TABLE1" onclick="return TABLE1_onclick()" >
              <tr>
                ...
                <td width="78%"><asp:TextBox ID="TextBox_Panel_Name" runat="server" CssClass="input_txt"></asp:TextBox>
            ...
            Display="Dynamic" ErrorMessage="Enter Module Name"></asp:RequiredFieldValidator></td>
              ...
              <tr>
                ...
                <td><asp:TextBox ID="TextBox_Panel_Priority" runat="server" CssClass="input_txt" MaxLength="5"></asp:TextBox>
...
ErrorMessage="Enter Valid Priority" ValidationExpression="(\d)*" Display="Dynamic"></asp:RegularExpressionValidator></td>
              ...
              <tr>
                ...
                <td style="height: 13px"><asp:ImageButton ID="ImageButton_Update_Pannel" runat="server" CommandName="Update" ImageUrl="images/save_btn.png" OnClick="ImageButton_Update_Pannel_Click" />
...
<asp:Panel ID="Panel_After_Logina" Visible="false" runat="server" ><asp:LinkButton ID="LinkButton1" Visible="false" runat="server"></asp:LinkButton></asp:Panel>

<asp:Label ID="Label1" runat="server" Text="" Visible="false"></asp:Label>

<asp:Panel ID="Panel_After_Loginb" Visible="false" runat="server"> <asp:Label ID="LabelName" runat="server" Text="" Visible="false"></asp:Label></asp:Panel>
