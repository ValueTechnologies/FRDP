<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="GeneratorMonthlyServiceRpt.aspx.cs" Inherits="FRDP.GeneratorMonthlyServiceRpt" %>
           ...
           <div class="row-fluid">
                            ...
                            <div class="box gradient">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        <span class="icon16 icomoon-icon-equalizer-2"></span>
                                        <span>Generator Service Report</span>
                                    </h4>
                                    <a href="#" class="minimize">Minimize</a>
                                </div>
                                <div class="content noPad">
