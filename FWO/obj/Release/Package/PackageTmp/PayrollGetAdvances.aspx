<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="PayrollGetAdvances.aspx.cs" Inherits="FRDP.PayrollGetAdvances" %>
            ...
            <div class="box gradient">
                ...
                <div class="content noPad" style="padding: 1px;">
                    ...
                    <form class="form-horizontal" action="#">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span4" for="normal">Advances / Loan Category</label>
