<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="Interviews.aspx.cs" Inherits="FRDP.Interviews" %>
            ...
            <div class="box gradient">
                ...
                <div class="title">
                    ...
                    <h4>
                        ...
                        <span>Select Job to Enter Interview Marks</span>
                    </h4>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function LoadDoctorsList() {
                ...
                $.ajax({
                    type: "POST",
                    url: "RecruitmentGH.ashx/?ID=9ǁ" + $('#ddlJobs').val(),
