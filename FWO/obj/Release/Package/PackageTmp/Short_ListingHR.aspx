<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="Short_ListingHR.aspx.cs" Inherits="FRDP.Short_ListingHR" %>
            ...
            <div class="box gradient">
                ...
                <div class="title">
                    ...
                    <h4>
                        ...
                        <span>Select Job for Short Listing</span>
                    </h4>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function LoadDoctorsList() {
                ...
                $.ajax({
                    type: "POST",
                    url: "RecruitmentGH.ashx/?ID=7ǁ" + $('#ddlJobs').val(),
            ...
            $('.btnEdit').live('click', function (e) {
                ...
                var val = btn.hasClass('btn-info') ? 1 : 0;
                $.ajax({
                    type: "POST",
                    url: "RecruitmentGH.ashx/?ID=8ǁ" + cid + "ǁ" + val,
                    success: function (response) {
                        if (val==1) {
