<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="EmFamilyInfo.aspx.cs" Inherits="FRDP.EmFamilyInfo" %>
            ...
            <div class="box gradient">
                ...
                <div id="PrintArea" class="content noPad" style="padding: 1px;">
                    ...
                    <div class="tab0 NoPrnt" style="margin-left: 5px; margin-bottom: 20px;">
                        &nbsp;<div class="tab1" style="float: left">&nbsp;Employee Family Information</div>
                        <div class="tab2">&nbsp;</div>
                    </div>
                    <div class="NoPrnt" style="margin-bottom: 20px;">
                        ...
                        <div class="span6">
                            ...
                            <div class="span7 controls sel" style="margin-left: 0px;">
                                <select id="Relations" class="nostyle">
                        ...
                        <div class="span6">
                            ...
                            <input id="txtRelationName" type="text" class="txtcs  span7 clsClear" />
                        </div>
                    </div>
                    ...
                    <div class="form-row row-fluid">
                        <div class="span6">
                            ...
                            <input id="txtRelationCNIC" type="text" class="txtcs  span7 clsClear" />
                        </div>
                        <div class="span6">
                            <label class="form-label span4" for="normal">Contact No</label>
                            <input type="text" id="txtRelationContact" class="txtcs  span7 clsClear" />
                        </div>
                    </div>
                    <div class="form-row row-fluid">
                        <div class="span6">
                            <label class="form-label span4" for="normal">Address</label>
                            <textarea id="txtRelationAddress" cols="20" rows="2" class="txtcs  span7 clsClear"></textarea>
                        </div>
                        <div class="span6">
                            <label class="form-label span4" for="normal">Details</label>
                            <textarea id="txtRelationDetails" cols="20" rows="2" class="txtcs  span7 clsClear"></textarea>
                        </div>
                    </div>
                    <div class="form-row row-fluid">
                        <div class="span6">
                            <label class="form-label span4" for="normal">DOB</label>
                            <input id="txtRelationDOB" type="text" class="txtcs  span7 clsClear dtDate" placeholder="dd/mm/yyyy" />
                        </div>
                        <div class="span6">
                            <label class="form-label span4" for="normal"></label>
                            <button type="button" value="0" class="btn btn-info" id="AddRelation">Save</button>
                            <button type="button" class="btn btn" id="CancelRelation">Cancel</button>
                        </div>
                    </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#AddRelation').live('click', function (e) {
                ...
                //if ($(this).val() != "0") {
                var vals = rowNumber + "ǁ" + $('#Relations').val() + "ǁ" + $('#txtRelationName').val() + "ǁ" + $('#txtRelationCNIC').val() + "ǁ" + $('#txtRelationContact').val() + "ǁ" + $('#txtRelationAddress').val() + "ǁ" + $('#txtRelationDetails').val() + "ǁ" + $('#txtRelationDOB').val() + "ǁ" + $("#EmpDisplay").attr('tg');
                    $.ajax({
                        type: "POST",
            ...
            $('.dtDate').datepicker({ dateFormat: 'dd/mm/yy', changeYear: true, changeMonth: true });
            $(function () {
                $("#txtCNIC,#txtRelationCNIC").mask('99999-9999999-9');
            });
