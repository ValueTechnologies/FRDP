<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="EmployeeInquires.aspx.cs" Inherits="FRDP.EmployeeInquires" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="box gradient">
                ...
                <div id="PrintArea" class="content noPad" style="padding: 1px;">
                    ...
                    <%-- End of div EmpDisplay--%>
                        ...
                        &nbsp;<div class="tab1" style="float: left">&nbsp;Employee Inquires</div>
                        <div class="tab2">&nbsp;</div>
                    </div>
                    <div class="NoPrnt" style="margin-bottom: 20px;">
                        <table style="width: 96.4%; margin-left: 20px; margin-right: 20px;">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 100px;">Inquiry Type</td>
                                    <td style="text-align: left; width: 40%;">
                    ...
                    <div class="tab0" style="margin-left: 5px; margin-bottom: 20px;">
                        &nbsp;<div class="tab1" style="float: left">&nbsp;Employee Inquiries History</div>
                        <div class="tab2">&nbsp;</div>
                    </div>
                    ...
                    <div class="NoPrnt" style="margin-bottom: 20px;padding-left:5px; padding-right:5px;">
    ...
    <script type="text/javascript">
        ...
        function Docs() {
            $.ajax({
                url: "exeDataIMS.ashx/?ID=" + encodeURIComponent("115ǁ" + $("#EmpDisplay").attr('tg') + "ǁ" + "EInq"),
        ...
        $(document).ready(function () {
            ...
            $('#btnSave').live('click', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "EmpReg.ashx/?ID=64ǁ" + $('#EmpDisplay').attr('tg') + "ǁ" + f + "ǁ" + Province,
                    success: function (response) {
            ...
            $(function() {
                $.ajax({
                    type: "POST",
                    url: "EmpReg.ashx/?ID=63ǁ",
                    success: function (response) {
                        var jd = $.parseJSON(response), opt = '';
                        $.each(jd, function (i, itm) {
                            opt += '<option>' + itm.strAwardType + '</option>';
                        });
