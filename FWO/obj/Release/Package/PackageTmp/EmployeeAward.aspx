<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="EmployeeAward.aspx.cs" Inherits="FRDP.EmployeeAward" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="box gradient">
                ...
                <div id="PrintArea" class="content noPad" style="padding: 1px;">
                    ...
                    <%-- End of div EmpDisplay--%>
                        ...
                        &nbsp;<div class="tab1" style="float: left">&nbsp;Employee Awards</div>
                        <div class="tab2">&nbsp;</div>
                    </div>
                    <div class="NoPrnt" style="margin-bottom: 20px;">
                        <table style="width: 96.4%; margin-left: 20px; margin-right: 20px;">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 100px;">Award Type</td>
                                    <td style="text-align: left; width: 40%;">
    ...
    <script type="text/javascript">
        ...
        function Docs() {
            $.ajax({
                url: "exeDataIMS.ashx/?ID=" + encodeURIComponent("115ǁ" + $("#EmpDisplay").attr('tg') + "ǁ" + "EAward"),
