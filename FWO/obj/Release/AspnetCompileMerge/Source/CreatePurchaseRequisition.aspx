<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="CreatePurchaseRequisition.aspx.cs" Inherits="FRDP.CreatePurchaseRequisition" %>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span12">
                                <div class="row-fluid">
                                    ...
                                    <label class="form-label span1">Officer:</label>
                                    <div class="span7">
        ...
        $(document).ready(function () {
            ...
            $('#btnsavet, #btnsavef, #btnsendt, #btnsendf').live('click', function () {
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    url: "CreatePurchaseRequisition.aspx/MakeRequisition",
