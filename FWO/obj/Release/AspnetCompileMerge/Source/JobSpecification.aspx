<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="JobSpecification.aspx.cs" Inherits="FRDP.JobSpecification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="span12">
            ...
            <div class="box gradient">
                ...
                <div class="title">
                    ...
                    <a id="btnMin" href="#" class="minimize">Minimize</a>
                </div>
    ...
    <div class="row-fluid" id="JRDtl" style="display: none;">
        <div class="span12">
                    ...
                    <table style="width: 96.4%; margin-left: 20px; margin-right: 20px;">
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 100px;">Grade/BPS</td>
                            ...
                            <tr>
                                <td colspan="4" style="text-align: right; padding-right: 2.5%;">
                                    <br />
                                    <button id="btndlogSave" value="0" type="button" class="frm btn btn-info">Approve</button>
                                    <button id="btndlogFinish" type="button" class="btn btn-info trupload" style="margin-left: 3px;">Discard</button></td>
                            </tr>
    ...
    <div id="dvApprove" title="Approve Job Requirement">
        <table style="width: 100%;">

            <tr>
                <td style="vertical-align: top;">Remarks</td>
                <td>
                    <textarea id="txtApprovalRemarks" cols="20" rows="2" style="margin: 0px 0px 10px; height: 71px; width: 282px;"></textarea></td>
            </tr>
            <tr>
                <td>Last Date To Apply</td>
                <td>
                    <input id="txtLastDate" type="text" /></td>
            </tr>

            <tr>
                <td></td>
                <td style="text-align: right;">
                    <button id="btnSave" value="0" type="button" class="frm btn btn-info">Approve</button></td>
            </tr>
        </table>
    </div>

    <div id="dvReject" title="Reject Job Requirement">
        <table style="width: 100%;">
            <tr>
                <td style="vertical-align: top;">Remarks</td>
                <td>
                    <textarea id="txtRejectRemarks" cols="20" rows="2" style="margin: 0px 0px 10px; width: 310px; height: 113px;"></textarea></td>
            </tr>
            <tr>
                <td></td>
                <td style="text-align: right;">
                    <button id="btnFinish" type="button" class="btn btn-info trupload" style="margin-left: 3px;">Discard</button></td>
            </tr>
        </table>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btndlogSave').live('click', function (e) {
                e.preventDefault();
                $('#dvApprove').dialog('open');
            });
            $('#btndlogFinish').live('click', function (e) {
                e.preventDefault();
            ...
            $('#btnSave').live('click', function (e) {
                ...
                if ($.trim($('#txtLastDate').val()) == "") {
                    alertR('Enter Last Date To Apply..!');
                    return false;
                }
                ...
                fromdata.append("frmData", encodeURIComponent(vals + "ǁ" + $('#txtApprovalRemarks').val() + "ǁ" + $('#txtLastDate').val()  + "ǁApproved" ));

                var choice = {};
                choice.url = "RecruitmentGH.ashx/?ID=4ǁ";
                choice.type = "POST";
                choice.data = fromdata;
                choice.contentType = false;
                choice.processData = false;
                choice.success = function (response) {
                    window.location.href = "JobSpecification.aspx";
                };
            ...
            $('#btnFinish').live('click', function (e) {
                ...
                fromdata.append("frmData", encodeURIComponent(vals + "ǁ" + $('#txtRejectRemarks').val() + "ǁNULLǁRejected"));
                var choice = {};
                choice.url = "RecruitmentGH.ashx/?ID=4ǁ";
                choice.type = "POST";
                choice.data = fromdata;
