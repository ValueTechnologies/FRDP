<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="GeneratorDataInputonoff.aspx.cs" Inherits="FRDP.GeneratorDataInputonoff" %>
...
<table style="width:96.4%; margin-left:20px; margin-right:20px;">
    ...
    <tr>
        ...
        <td style="text-align:left; width: 40%;">
            <input class="onoff" type="text" style="width:90%;" /></td>
        ...
        <td style="text-align:left;">
            <input class="onoff" type="text" style="width:90%;" /></td>
                    ...
                    <tr>
        <td style="width:100px;">Starting HRS</td>
        <td style="text-align:left; width: 40%;">
            <input class="onoff" type="text" style="width:90%;" /></td>
        <td style="width:100px;">Ending HRS</td>
        <td style="text-align:left;">
            <input class="onoff" type="text" style="width:90%;" /></td>
    </tr>
                            ...
                            <tr>
        <td style="width:100px;">Starting (KWH)</td>
        <td style="text-align:left; width: 40%;">
            <input class="onoff" type="text" style="width:90%;" /></td>
        <td style="width:100px;">Ending (KWH)</td>
        <td style="text-align:left;">
            <input class="onoff" type="text" style="width:90%;" /></td>
    </tr>
        ...
        <tr>
            ...
            <td></td>
            <td></td>
            <td><button class="btn btn-info" id="btnonoff" type="button" style="margin-top: 6px;">Save</button>
                <button class="btn" id="btnonoffCancel" type="button" style="margin-top: 6px;">Cancel</button>
            </td>
        </tr>
    </tbody>
</table>
...
<td>' + itm.OilLtrs + '</td>\
            ...
            function tblOnOffLoad() {
                ...
                $.ajax({
                    type: "POST",
                    url: "gen.ashx/?ID=20ǁ" + $('#SelectGenerator').val() + "ǁ" + $($('.onoff')[0]).val(),
                    success: function (response) {
                        var jd = $.parseJSON(response), opt = '';
                        //alert(response);
                        $.each(jd, function (i, itm) {
