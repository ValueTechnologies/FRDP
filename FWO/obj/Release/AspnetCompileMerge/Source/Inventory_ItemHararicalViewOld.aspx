<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="Inventory_ItemHararicalViewOld.aspx.cs" Inherits="FRDP.Inventory_ItemHararicalViewOld" %>
            ...
            <div class="box gradient">
                ...
                <div class="content noPad">
                    ...
                    <div style="margin: 10px;">
                        Level of hierarchy  
                        <input id="txtTotalLevel" class="Integer" type="text" style="width: 50px" value="0" />
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="box gradient">
                ...
                <div class="content noPad">
<%--                    <br />
      <button id="btnAddRoot" class="btn btn-info" style="float:right; margin-right:10px;">Add Root</button><br />--%>
        ...
        $(document).ready(function () {
            ...
            $('#btnAddNode').live('click', function () {
                ...
                if (lid == 'NULL') {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "inv.ashx/?ID=5ǁ" + encodeURIComponent($('#txtIAddtemName').val()) + "ǁ" + $('#btnAddNode').attr('lid') + "ǁ" + chk + "ǁ" + encodeURIComponent($('#ddlUnit').val()) + "ǁ" + $('#txtAlert').val() + "ǁ" + encodeURIComponent($('#txtMenufecturer').val()) + "ǁ" + encodeURIComponent($('#txtDescription').val()),
                        success: function (response) {
                            alertG('Record Saved');
                            $('#txtIAddtemName').val('');
