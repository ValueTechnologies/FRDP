<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="PersonalRequisitionFormApproval.aspx.cs" Inherits="FRDP.PersonalRequisitionFormApproval" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
           <div id="frmDtl" style="display:none;" class="row-fluid">
                                <div class="span12">
        ...
        <tr>
            <td colspan="4">
                <div class="tab0" style="margin-left: 5px; margin-bottom: 20px;">
                        ...
                        <div style="margin-bottom: 20px;">
<div>1&nbsp;&nbsp; Total Catchment Population : <input id="txtTotalPopulation" class="frm clr"  type="text" /></div>
                            <div>2&nbsp;&nbsp; OPD & MCH Report : <input id="txtOPD" class="frm clr" type="text" /></div>
                            <hr />
                            <div>3&nbsp;&nbsp; Distance From DSU : <input id="txtDistance" class="frm clr"  type="text" /></div>
                            <div>4&nbsp;&nbsp; Details of Contract & Regular Staff;<br />
                                <ul><li><select id="PostType"  class="frm" style="width: 100px;border: none;"><option>Regular</option><option>Contract</option></select>
        ...
        <tr  class="NoPrnt">
            ...
            <td>Date</td>
            <td><input type="text" id="DecisionDate" class="dtDate" /></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
                <tr  class="NoPrnt">
            ...
            <td>Remarks</td>
            <td colspan="3">
                <textarea id="TextArea1" cols="20" rows="2" style="width:96%;"></textarea>
            </td>
        </tr>
                                                                                                                 <tr class="fwd NoPrnt" style="display:none;">
                                        <td>Office Type</td>
                                        <td>
                ...
                <tr>
            <td colspan="4">
                                                <div id="btomline" style="text-align:right;"><br />Signature:______________________<br /><br />Name : <%: Session["username"] %> <br /><br />
  Title:<%: Session["designation"] %> <br /><br /></div>
            </td>
        </tr>
        <tr class="fwd NoPrnt" style="display:none;">
            <td colspan="4">
                                <button id="btnSend" type="button" class="btn btn-info">Send Forward</button> <button id="btnCancel1" class="btn btn" type="button">Cancel</button>
            </td>
        </tr>
        <tr class="NoPrnt btns">
            <td colspan="4">
                <button id="btnSave" type="button" class="btn btn-info">Send Personal Requisition</button> <button id="btnPrnt" style="display:none;" class="btn btn-info" type="button">Print Personal Requisition</button>
                <button id="btnApprove" type="button" class="btn btn-info">Approve</button>
                <button id="btnReject" type="button" class="btn btn-info">Reject</button>
                <button id="btnForward" type="button" class="btn btn-info">Forward</button> <button id="btnCancel" class="btn btn" type="button">Cancel</button>
            </td>
        </tr>
    </tbody>
        </table>
           ...
           <div class="row-fluid">
                            ...
                            <div class="box gradient">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        <span class="icon16 icomoon-icon-equalizer-2"></span>
                                        <span>Received Personal Requisition Forms</span>
                                    </h4>
                                    <a href="#" class="minimize">Minimize</a>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnApprove').live('click', function (e) {
                ...
                if ($('#TextArea1').val() == "") {
                    alertR('Enter Valid Remarks..!');
                    return false;
                }
                $.ajax({
                    type: "POST",
                    url: "EmpReg.ashx/?ID=94ǁ" + $('#frmDtl').attr('tg') + "ǁ" + $('#DecisionDate').val() + "ǁ" + $('#TextArea1').val(),
            ...
            $('#btnReject').live('click', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "EmpReg.ashx/?ID=95ǁ" + $('#frmDtl').attr('tg') + "ǁ" + $('#DecisionDate').val() + "ǁ" + $('#TextArea1').val(),
                    success: function (response) {
            ...
            $('#btnSend').live('click', function (e) {
                ...
                if ($('#storeInchargeEmpID').val() == "" || $('#storeInchargeEmpID').val() == null || $('#storeInchargeEmpID').val() == undefined) {
                    alertR('Select Valid Person To forward..!');
                    return false;
                }
                $.ajax({
                    type: "POST",
                    url: "EmpReg.ashx/?ID=96ǁ" + $('#frmDtl').attr('tg') + "ǁ" + $('#DecisionDate').val() + "ǁ" + $('#TextArea1').val() + "ǁ" + $('#storeInchargeEmpID').val(),
                    success: function (response) {
                        LoadDoctorsList();
                        $('#txtDate').val('');
                        $('#frmDtl').hide();
            ...
            $('#btnForward').live('click', function (e) {
            ...
            $('#btnCancel1').live('click', function (e) {
                e.preventDefault();
                $('.btns').show();
                $('.fwd').hide();
            });
