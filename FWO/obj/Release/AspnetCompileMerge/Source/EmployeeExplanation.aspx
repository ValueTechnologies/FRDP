<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="EmployeeExplanation.aspx.cs" Inherits="FRDP.EmployeeExplanation" %>
                ...
                <div id="PrintArea" class="content noPad" style="padding: 1px;">
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="text-align: center; font-variant: small-caps; font-size: x-large; font-weight: bold;">
                                    ...
                                    Employee Explanation Report</td>
                            </tr>
                    </table><hr />
                    ...
                    <%-- End of div EmpDisplay--%>
                        ...
                        &nbsp;<div class="tab1" style="float: left">&nbsp;Employee Explanation</div>
                        <div class="tab2">&nbsp;</div>
                    </div>
                    <div class="NoPrnt" style="margin-bottom: 20px;">
                        <table style="width: 96.4%; margin-left: 20px; margin-right: 20px;">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 100px;">Explanation Type</td>
                                    <td style="text-align: left; width: 40%;">
                                        <select id="ddlExplanationType" class="frm" style="width: 387px;">
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    <td>Reason</td>
                                    <td>
                                        <input id="txtReason" type="text" class="frm" style="width: 90%;" /></td>
                                    <td>Remarks</td>
                                    <td>
                    ...
                    <div class="tab0" style="margin-left: 5px; margin-bottom: 20px;">
                        &nbsp;<div class="tab1" style="float: left">&nbsp;Employee Explanations History</div>
                        <div class="tab2">&nbsp;</div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#btnSave').live('click', function (e) {
                ...
                if ($('#ddlExplanationType').val() == "" || $('#ddlExplanationType').val() == undefined || $('#ddlExplanationType').val() == null || $('#ddlExplanationType').val() == "{NEW ELEMENT}") {
                    alertR('Select Explanation Type...!');
                    return false;
                }
                if ($('#txtDate').val() == "") {
                ...
                $.ajax({
                    type: "POST",
                    url: "EmpReg.ashx/?ID=67ǁ" + $('#EmpDisplay').attr('tg') + "ǁ" + f + "ǁ" + Province,
                    success: function (response) {
                        alertG('Rrecord Saved');
                        getExplanations($('#EmpDisplay').attr('tg'));
                    }
                });
            ...
            $(function() {
                $.ajax({
                    type: "POST",
                    url: "EmpReg.ashx/?ID=66ǁ",
                    success: function (response) {
                        var jd = $.parseJSON(response), opt = '';
                        $.each(jd, function (i, itm) {
                            opt += '<option>' + itm.strExplanationType + '</option>';
                        });
                        $('#ddlExplanationType').html(opt);
                        $('#ddlExplanationType').eComboBox();
                    }
                });
            });
