<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="accbVxx.aspx.cs" Inherits="FRDP.accbVxx" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <table id="rdBtn" style="width: 100%;">
    ...
    <div id="Parea" class="pcontant" style="width: 78%">
        <table>
            <tr>
                <td></td>
                <td>
            ...
            <tr>
                <td></td>
                <td colspan="2" style="text-align: center; font-variant: small-caps; font-size: x-large; font-weight: bold;">Bank Voucher</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                ...
                <td colspan="2">
                    <table style="width: 100%;">
                        <tr>
                            <td>
                                <div id="JVNO" title="BPV/<%:Fn.GetRecords("SELECT COUNT(isnull(VoucherID,0))+1 AS VNo FROM TblVoucherHDR WHERE (CompanyID = "+Request.Cookies["br"].Value+") AND ({ fn MONTHNAME(EntryDate) } + ' ' + CONVERT(varchar, YEAR(EntryDate)) = '"+Convert.ToDateTime(Session["ActMth"]).ToString("MMMM yyyy")+"') AND (VoucherNo LIKE N'BPV%')")[0] %>" style="float: left; font-weight: bold;">Voucher No. BPV/<%:Fn.GetRecords("SELECT COUNT(isnull(VoucherID,0))+1 AS VNo FROM TblVoucherHDR WHERE (CompanyID = "+Request.Cookies["br"].Value+") AND ({ fn MONTHNAME(EntryDate) } + ' ' + CONVERT(varchar, YEAR(EntryDate)) = '"+Convert.ToDateTime(Session["ActMth"]).ToString("MMMM yyyy")+"') AND (VoucherNo LIKE N'BPV%')")[0] %></div>
                            </td>
                        ...
                        <tr>
                            <td>
                                <strong>Bank :&nbsp; </strong>
                                &nbsp;<asp:DropDownList ID="ddBanks" runat="server" Width="303px" DataSourceID="dsBanks" DataTextField="titl" DataValueField="AcID" ClientIDMode="Static">
                                </asp:DropDownList>
                            ...
                            <td style="text-align: right">
                                <strong>Ref. # :<asp:TextBox ID="txCheqNo" runat="server" ClientIDMode="Static"></asp:TextBox>
                                </strong></td>
                        </tr>
                        <tr>
                            <td>
                                <span id="psource">Payee :</span>
                                <input id="txPayee" type="text" style="width: 300px" /></td>
                            <td style="text-align: right">&nbsp;</td>
                        </tr>
                        <tr>
                            <td colspan="2">
            ...
            $('#btnSaveV').click(function () { //get data from table
                if (vdcheck()) {
                    ...
                    $.ajax({
                        ...
                        success: function (responseText) {
                            if (responseText != "[]") {
                                $('#ddBanks').parent().html('<strong style="font-size: 16px;">Bank : ' + document.getElementById("ddBanks").options[document.getElementById('ddBanks').selectedIndex].text) + '</strong>';
