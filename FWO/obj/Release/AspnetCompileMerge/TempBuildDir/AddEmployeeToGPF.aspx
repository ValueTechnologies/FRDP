<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="AddEmployeeToGPF.aspx.cs" Inherits="FRDP.AddEmployeeToGPF" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#ddlCurrentAppointedAt').live('change', AllOffices);
            ...
            function AllOffices() {
                $.ajax({
                    ...
                    url: "EmployeeRegistration.aspx/AllNewOffice",
                    data: "{'IsHeadoffice':'" + $('#ddlCurrentAppointedAt').val() + "'}",
                    async: false,
                    success: function (responseText) {
                        var jData = $.parseJSON(responseText.d), out = "";
                        $.each(jData, function (i, item) {
                            out = out + '<option value="' + item.OfficeID + '">' + item.OfficeName + '</option>';
                        });
                        $('#ddlCurrentOffice').html(out);
            ...
            $('#btnSave').bind('click', function () {
                if ($('#ddlCurrentOffice').val() == undefined) {
                ...
                $.ajax({
                    ...
                    data: "{ 'OfficeName' : '" + $('#ddlCurrentOffice').val() + "' , 'AccountNo' : '" + $('#txtAccountNo').val().trim() + "', 'EmpID' : '" + $('#btnSave').attr('tag') + "' }",
                    success: function (response) {
                        $('#txtOfficeName').val('');
                        $('#txtAccountNo').val('');
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <form class="form-horizontal" action="#">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span4" for="normal">Office Type</label>
                                <div class="span7 controls sel" style="margin-left: 0px;">
                                    <select id="ddlCurrentAppointedAt" class="txtcs frmCtrl nostyle">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span4" for="normal">Appointed Office.</label>
                                <div class="span7 controls sel" style="margin-left: 0px;">
                                    <select id="ddlCurrentOffice" class="txtcs frmCtrl nostyle">
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                ...
                                <input id="txtAccountNo" type="text" class="txtcs frmCtrl span7" />
                            </div>
                        </div>
