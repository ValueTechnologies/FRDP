<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.master" AutoEventWireup="true" CodeBehind="Generator.aspx.cs" Inherits="FRDP.Generator" %>
    ...
    <tr>
        ...
        <tr>
            ...
            <td><input id="txtCapacity" class="gen" type="text" style="width:90%;" /></td>
                ...
                <tr>
            <td>Fule Tank Size</td>
            <td><input id="txtFuleTankSize"  class="gen"  type="text" style="width:90%;" /></td>
            <td>Fule Filter Modal</td>
            <td><input id="txtFuleFilterModal" class="gen" type="text" style="width:90%;" /></td>
        </tr>
        ...
        <tr>
            ...
            <td><input id="txtServiceDurationHours" class="gen Integer" type="text" style="width:90%;" /></td>
                        ...
                        <tr>
            <td>Min Fule Level (Liter)</td>
            <td><input id="txtMinFuleLevelLiter"  class="gen Integer"  type="text" style="width:90%;" /></td>
                            ...
                            <div class="content">
                                <div class="you">
                                    <ul class="unstyled">
                                        ...
                                        <li><span class="icon16 icomoon-icon-arrow-right-2"></span>Fule Tank Size: <strong class="red"><span id="FuleTankSize">Fule Tank Size</span></strong></li>
                                        <li><span class="icon16 icomoon-icon-arrow-right-2"></span>Fule Filter Modal: <strong class="red"><span id="FuleFilterModal">Fule Filter Modal</span></strong></li>
                                ...
                                <div class="client">
                                    <ul class="unstyled">
                                        ...
                                        <li><span class="icon16 icomoon-icon-arrow-right-2"></span>Min FuleLevel Liter: <strong class="red"><span id="MinFuleLevelLiter">Min Fule Level Liter</span></strong></li>
...
<td>' + itm.MeterKWHEnd + '</td>\
            ...
            function FillData(obj)
            {
                ...
                $('#FuleTankSize').html(obj[0].FuleTankSize);
                $('#FuleFilterModal').html(obj[0].FuleFilterModal);
                ...
                $('#MinFuleLevelLiter').html(obj[0].MinFuleLevelLiter);
