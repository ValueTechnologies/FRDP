<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="PayrollDirectorateWiseDeductionsDetailReport.aspx.cs" Inherits="FRDP.PayrollDirectorateWiseDeductionsDetailReport" %>
    ...
    <div class="row-fluid">
      ...
      <script type="text/javascript">
          ...
          $(document).ready(function () {
              $('.heading h3').html('Office Wise Deduction Detail Report');
