<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="GPFAllEmployeesDetail.aspx.cs" Inherits="FRDP.GPFAllEmployeesDetail" %>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                ...
                                <div class="span7" style="margin-left: 0px;">
                                    ...
                                    <asp:SqlDataSource runat="server" ID="SqlDSDept" ConnectionString="<%$ ConnectionStrings:VD_DB_ConnectionString %>" SelectCommand="Select 0 as DepartmentID, ' ---All---' as DepartmentName union SELECT        DepartmentID, DepartmentName FROM            tbl_Departments"></asp:SqlDataSource>                                </div>
                            </div>
                            <div class="span6">
                                ...
                                <div class="span7" style="margin-left: 0px;">
                                    ...
                                    <asp:SqlDataSource runat="server" ID="SqlDSDesignation" ConnectionString="<%$ ConnectionStrings:VD_DB_ConnectionString %>" SelectCommand="Select 0 as DesignationID, ' ---All---' as Designation union SELECT        DesignationID, Designation FROM            tbl_Designation"></asp:SqlDataSource>                                </div>
                            </div>
                        </div>
