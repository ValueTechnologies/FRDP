<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="EditGrossSalaryN.aspx.cs" Inherits="FRDP.EditGrossSalaryN" %>
                    ...
                    <form class="form-horizontal" action="#">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                ...
                                <input id="txtSalaryDate" type="text" class="txtcs frmCtrl span4 " />
                            </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">Integrated Allow/Spl.Pay </label>
                                <input id="txtIntegratedAllow" type="text" class="txtcs frmCtrl span4 numeric clsAllowanceItem" />
                            </div>
                            <div class="span6">
                                <label class="form-label span6" for="normal">Medical Allow.current B.pay</label>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">7.5% Adhoc Allowance</label>
                                <input id="txtAdhocAllowance" type="text" class="txtcs frmCtrl span4 numeric clsAllowanceItem" />
                            </div>
                            <div class="span6">
                        ...
                        <div class="form-row row-fluid">
                            ...
                            <div class="span6">
                                <label class="form-label span6" for="normal">Adhoc Allowance Empty</label>
                                <input id="txtAdhocAllowanceEmpty" type="text" class="txtcs frmCtrl span4 numeric clsAllowanceItem" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            ...
                            <div class="span6">
                                <label class="form-label span6" for="normal">Adhoc Relief 10 %</label>
                                <input id="txtAdhocRelief10Percent" type="text" class="txtcs frmCtrl span4 numeric clsAllowanceItem" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            ...
                            <div class="span6">
                                <label class="form-label span6" for="normal">Qualification Allowance</label>
                                <input id="txtQualificationAllowance" type="text" class="txtcs frmCtrl span4 numeric clsAllowanceItem" />
                            </div>
                        </div>

                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">10 % A. Allow (2013)</label>
                                <input id="txtTenPercentAAllowancePreviousYear" type="text" class="txtcs frmCtrl span4 numeric clsAllowanceItem" />
                            </div>
                            <div class="span6">
                                <label class="form-label span6" for="normal">Spl Relief Allowance 30%</label>
                                <input id="txtSplReliefAllowance30Percent" type="text" class="txtcs frmCtrl span4 numeric clsAllowanceItem" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">Driving Allowance</label>
                                <input id="txtDrivingAllowance" type="text" class="txtcs frmCtrl span4 numeric clsAllowanceItem" />
                            </div>
                            <div class="span6">
                                <label class="form-label span6" for="normal">50% Adhoc Allow BP Nov 10  </label>
                                <input id="txtAdhocAllowBPNov10" type="text" class="txtcs frmCtrl span4 numeric clsAllowanceItem" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            ...
                            <div class="span6">
                                <label class="form-label span6" for="normal">20% Spl. Allow June Basic</label>
                                <input id="txtSPlAllwJuneBasic20Percent" type="text" class="txtcs frmCtrl span4 numeric clsAllowanceItem" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            ...
                            <div class="span6">
                                ...
                                <input id="txtGrossSalary" type="text" class="txtcs frmCtrl span4 numeric clsGrossSalary" disabled="disabled" />
                            </div>
                        </div>
</div><%--END OF tab0--%>
...
<div class="tab0" style="margin-left: 5px; margin-bottom: 20px;">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">Staff Ledger</label>
                                <input id="txtStaffLedger" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                            <div class="span6">
                                <label class="form-label span6" for="normal">Income Tax</label>
                                <input id="txtIncomeTax" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">Trade Tax </label>
                                <input id="txtTradeTax" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                            <div class="span6">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">Personnel Instalment</label>
                                <input id="txtPersonnelInstalment" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                            <div class="span6">
                                <label class="form-label span6" for="normal">PGSHF / GRLS Loan</label>
                                <input id="txtGRLSLoan" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">Haj Fund</label>
                                <input id="txtHajFund" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                            <div class="span6">
                                <label class="form-label span6" for="normal">Benevolent Fund</label>
                                <input id="txtBenevolentFund" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            ...
                            <div class="span6">
                                <label class="form-label span6" for="normal">Motor Cycle</label>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">House Building</label>
                                <input id="txtHouseBuilding" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                            <div class="span6">
                                <label class="form-label span6" for="normal">Salary Slip Charges</label>
                                <input id="txtSalarySlipCharges" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                        </div>

                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">PUT:Micro Finance</label>
                                <input id="txtPUTMicroFinance" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                            <div class="span6">
                                <label class="form-label span6" for="normal">Union Fund</label>
                                <input id="txtUnionFund" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">Shop</label>
                                <input id="txtShop" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                            <div class="span6">
                                <label class="form-label span6" for="normal">Eid Advance/SPL</label>
                                <input id="txtEidAdvance" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                        </div>
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                <label class="form-label span6" for="normal">Govt. Residence</label>
                                <input id="txtGovtResidence10" type="text" class="txtcs frmCtrl span4 numeric clsDeductions" />
                            </div>
                            <div class="span6">
                                <label class="form-label span6" for="normal">Total Deduction</label>
                                <input id="txtTotalDeduction" type="text" class="txtcs frmCtrl span4 numeric clsTotalDeductions" disabled="disabled" />
                            </div>
                        </div>
</div><%--END OF tab0--%>
            ...
            <tr>
                ...
                <td>
                    <div class="controls sel">
                        <select id="ddlSalaryYear" class="nostyle">
                        </select>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            function GetPreviousMonthlySalary() {
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    url: "EditGrossSalary.aspx/GetPrevousSalary",
                    data: "{ 'EmpID' : '" + $('#btnSearchPreviousSalary').attr('tag') + "', 'Month' : '" + $('#ddlSalaryMonth').val() + "', 'Year' : '" + $('#ddlSalaryYear').val() + "'}",
                    success: function (response) {
                        ...
                        if (jData.length == 1) {
                            $.each(jData, function (i, item) {
                                ...
                                $('#SearchMinimizer,#toTop').click();
                                EmpDisplayFunc($('#btnSave').attr('tag'));
