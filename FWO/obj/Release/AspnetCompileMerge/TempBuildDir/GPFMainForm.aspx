<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="GPFMainForm.aspx.cs" Inherits="FRDP.GPFMainForm" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            function Years() {
                for (var i = 1947; i <= (new Date).getFullYear() + 1; i++) {
                    $('#ddlFromYear').prepend('<option>' + i + '</option>');
                }

                $('#ddlFromYear').val((new Date).getFullYear());
                $('#txtToYear').val((new Date).getFullYear() + 1);
            }

            //Change Year
            $('#ddlFromYear').bind('change', function () {
                $('#txtToYear').val(parseInt($('#ddlFromYear').val(), 10) + 1);
            ...
            $('#txtProfitRate').live('keyup', function () {
            ...
            click: function () {
                ...
                $('.clsContribution').each(function () {
                    ...
                    $.ajax({
                        ...
                        data: "{ 'Month' : '" + month + "', 'EmpID' : '" + id + "', 'ContributionAmount' : '" + amount + "', 'FromYear' : '" + $('#ddlFromYear').val() + "',  'ToYear' : '" + $('#txtToYear').val() + "'}",
                        success: function (response) {
                            LoadBalanceStatuses();
                        }
                    });
                ...
                $('.clsARecovery').each(function () {
                    ...
                    $.ajax({
                        ...
                        data: "{ 'Month' : '" + month + "', 'EmpID' : '" + id + "', 'RecoveryAmount' : '" + amount + "', 'FromYear' : '" + $('#ddlFromYear').val() + "',  'ToYear' : '" + $('#txtToYear').val() + "'}",
                        success: function (response) {
                            LoadBalanceStatuses();
                        }
                    });
        ...
        function CurruntYearAdvances() {
            $.ajax({
                ...
                data: "{ 'EmpID' : '" + $('#btnSaveNewAdvance').attr('tag') + "', 'FromYear' : '" + $('#ddlFromYear').val() + "',  'ToYear' : '" + $('#txtToYear').val() + "'}",
                async: false,
                success: function (responseText) {
                    var jData = $.parseJSON(responseText.d), out = "";
                    $.each(jData, function (i, item) {
        ...
        function CurruntYearDeposits() {
            $.ajax({
                ...
                data: "{ 'EmpID' : '" + $('#btnSaveNewDeposit').attr('tag') + "', 'FromYear' : '" + $('#ddlFromYear').val() + "',  'ToYear' : '" + $('#txtToYear').val() + "' }",
                async: false,
                success: function (responseText) {
                    var jData = $.parseJSON(responseText.d), out = "";
                    $.each(jData, function (i, item) {
        ...
        function CurruntYearInsuInstallments() {
            $.ajax({
                ...
                data: "{ 'EmpID' : '" + $('#btnSaveNewInsurance').attr('tag') + "' , 'FromYear' : '" + $('#ddlFromYear').val() + "',  'ToYear' : '" + $('#txtToYear').val() + "'}",
                async: false,
                success: function (responseText) {
                    var jData = $.parseJSON(responseText.d), out = "";
                    $.each(jData, function (i, item) {
        ...
        function LoadPreviousGPFOwnContribution() {
            ...
            $.ajax({
                ...
                data: "{ 'EmpID' : '" + $('#btnSaveContributionRecovery').attr('tag') + "', 'FromYear' : '" + $('#ddlFromYear').val() + "',  'ToYear' : '" + $('#txtToYear').val() + "'}",
                success: function (response) {
        ...
        function SaveProfit() {
            ...
            $.ajax({
                ...
                data: "{ 'EmpID' : '" + $('#btnSaveContributionRecovery').attr('tag') + "', 'NetGPF' : '" + $('#txtProfitRate').attr('tag') + "', 'ProfitRate' : '" + $('#txtProfitRate').val() + "', 'FromYear' : '" + $('#ddlFromYear').val() + "',  'ToYear' : '" + $('#txtToYear').val() + "'}",
                success: function (response) {
                    alert('Save Successfully!');
                }
            });
                    ...
                    <form class="form-horizontal" action="#">
                        ...
                        <div class="form-row row-fluid">
                            <div class="span6">
                                ...
                                <div class="span3 controls sel" style="margin-left: 0px;">
                                    <select id="ddlFromYear" class="nostyle">
                                    </select>
                                </div>
                            </div>
                            <div class="span6">
                                <label class="form-label span5" for="normal">To Year</label>
                                <input class="span3" id="txtToYear" type="text" disabled="disabled" />
                            </div>
                        </div>
                            ...
                            <div class="span12">
                                <table style="width: 100%; margin-left: 5%; margin-top: 5%;">
                                    <tr>
                                        ...
                                        <td>
                                            <label title="Total Recovery" id="lblTotalRecovery">...............</label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 150px; padding: 20px;">
                                        ...
                                        <td>
                                            <label title="Total GPF" id="lblTotalGPF">...............</label>
                                        </td>
                                        ...
                                        <td>
                                            <label title="Total Advance" id="lblTotalAdvance">...............</label>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <label title="Net GPF" id="lblNetGPF">...............</label>
                                        </td>
