<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="CreateGRN.aspx.cs" Inherits="FRDP.CreateGRN" %>
                ...
                <div class="content noPad">
                    ...
                    <table style="width: 99%; margin-left: 20px; margin-right: 20px;">
                        <tr>
                            ...
                            <td>
                                <input type="text" value="GRN-00001" disabled="disabled" /></td>
