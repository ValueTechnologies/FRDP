<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageD.Master" AutoEventWireup="true" CodeBehind="ItemsIssue.aspx.cs" Inherits="FRDP.ItemsIssue" %>
        ...
        <div class="span10">
            ...
            <div class="email-content">
                ...
                <div class="read-email well">
                                    ...
                                    <table id="tblReqitsms" class="responsive table table-striped table-bordered table-condensed" style="border-right: 1px solid #c4c4c4;">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td id="totalReqAvailable" style="text-align: center; font-weight: bold;"></td>
                                                <td></td>
                                                <td id="totalReqIssue" style="text-align: center; font-weight: bold;"></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                </div>
                    ...
                    <div style="text-align: right;">
                        <div class="actions">
                            <button id="btnReqsendf" r="0" st="2" class="btn btn-danger marginR10"><strong>Issue Now</strong></button>
                            <button id="btnReqdiscardf" class="btn btn-info marginR10">Issue Later</button>
                            <button id="btnReqsavef" r="0" st="1" class="btn marginR10">Just Save</button>
                        </div>
                    </div>
                </div>
                <!-- End .read-email -->
           ...
           <tbody>\
            ...
            function Loadreqlist() {
               var searchparam = $('.sideBtns.active').attr('prm');
                $.ajax({
                    type: "POST",
                    url: "inv.ashx/?ID=38ǁ" + searchparam,
                    success: function (response) {
            ...
            $('#btnReqsendf').live('click', function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "inv.ashx/?ID=39ǁ" + $this.attr('rid') + "ǁ" + $this.attr('st'),
                    success: function (response) {
                        $('.read-email').fadeOut(200);
                        $('.email-content>.box.plain').fadeIn(300);
                        $('#toTopHover').click();
                    ...
                    success: function (response) {
                        ...
                        $.each(jd, function (i, j) {
                            ...
                            opt += '<tr iid="' + j.tblInvReqSubID + '">\
                                                ...
                                                <td>' + j.Unit + '</td>\
                                                <td>\
                                                   <input class="txtReqItemIssue Integer" ReqSubID="'+ j.tblInvReqSubID + '" requiredQty="' + j.Quantity + '" availableqty="' + j.Availability + '" issued="' + j.QuantityIssued + '" type="text" value="' + j.QuantityIssued + '" style="width: 78%;" /> \
                                                </td>\
                                            </tr>'
                        });
